...
public class DragController {
     ...
     * @param dragMode The drag action
     */
    public void startDrag(View v, DragSource source, Object dragInfo, DragMode dragMode) {
        ...
        if (dragMode == DragMode.DRAG_MODE_MOVE) {
        ...
        if (dropTarget != null) {
            ...
            if (dropTarget.acceptDrop(mDragSource, coordinates[0], coordinates[1],
                ...
                dropTarget.onDrop(mDragSource, coordinates[0], coordinates[1],
                        (int) mTouchOffsetX, (int) mTouchOffsetY, mDragView, mDragInfo);
                mDragSource.onDropCompleted((dropTarget instanceof View ? (View) dropTarget : null), true);
                return true;
            } else {
                mDragSource.onDropCompleted((dropTarget instanceof View ? (View) dropTarget : null), false);
                return true;
            }
        }
        return false;
